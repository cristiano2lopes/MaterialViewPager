...
public class MaterialViewPagerSettings implements Parcelable {
    ...
    //com.github.florent37.com.github.florent37.materialviewpager

    public static final Creator<MaterialViewPagerSettings> CREATOR = new Creator<MaterialViewPagerSettings>() {
        public com.github.florent37.materialviewpager.MaterialViewPagerSettings createFromParcel(Parcel source) {
            return new com.github.florent37.materialviewpager.MaterialViewPagerSettings(source);
        }

        public com.github.florent37.materialviewpager.MaterialViewPagerSettings[] newArray(int size) {
            return new com.github.florent37.materialviewpager.MaterialViewPagerSettings[size];
        }
    };
